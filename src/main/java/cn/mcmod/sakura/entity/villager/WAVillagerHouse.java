...
public class WAVillagerHouse extends StructureVillagePieces.Village {
    ...
    public WAVillagerHouse(StructureVillagePieces.Start start, int type, Random rand, StructureBoundingBox boundingBox,
                           EnumFacing facing) {
        super(start, type);
    ...
    @Nullable
    public static WAVillagerHouse createPiece(StructureVillagePieces.Start start, List<StructureComponent> list,
                                              Random rand, int minX, int minY, int minZ, EnumFacing facing, int type) {
    ...
    public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
        ...
        setBlockState(worldIn, iblockstate000, 6, 1, 4, structureBoundingBoxIn);
        setBlockState(worldIn, iblockstate000, 5, 1, 4, structureBoundingBoxIn);
        setBlockState(worldIn, iblockstate000, 4, 1, 4, structureBoundingBoxIn);
        setBlockState(worldIn, iblockstate000, 3, 1, 4, structureBoundingBoxIn);
        ...
        createVillageDoor(worldIn, structureBoundingBoxIn, randomIn, 1, 1, 0, EnumFacing.NORTH);
