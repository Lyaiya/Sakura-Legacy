...
public class ItemFuton extends Item {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
        ...
        if (player.canPlayerEdit(pos, facing, itemstack) && player.canPlayerEdit(blockpos, facing, itemstack)) {
            ...
            boolean flag1 = blockState.getBlock().isReplaceable(worldIn, blockpos);
            ...
            if (flag2 && flag3 && worldIn.getBlockState(pos.down()).isTopSolid() && worldIn.getBlockState(blockpos.down()).isTopSolid()) {
                IBlockState iblockstate2 = BlockLoader.FUTON.getDefaultState()
                        .withProperty(BlockFuton.OCCUPIED, Boolean.FALSE)
                ...
                worldIn.notifyNeighborsRespectDebug(blockpos, blockState.getBlock(), false);
