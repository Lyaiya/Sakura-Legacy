...
public class ModelSamuraiArmors extends ModelCustomArmor {
    private final ModelRenderer OrnamentL;
    private final ModelRenderer OrnamentL2;
    private final ModelRenderer OrnamentL3;
    private final ModelRenderer OrnamentR;
    private final ModelRenderer OrnamentR2;
    private final ModelRenderer OrnamentR3;
    ...
    private final ModelRenderer flapR;
    private final ModelRenderer flapL;
    private final ModelRenderer Gemornament;
    private final ModelRenderer Gemornament2;
    private final ModelRenderer Gemornament3;
    ...
    private final ModelRenderer ShoulderplateR2;
    private final ModelRenderer ShoulderplateR3;
    ...
    private final ModelRenderer ShoulderplateL2;
    private final ModelRenderer ShoulderplateL3;
    private final ModelRenderer LegpanelR4;
    private final ModelRenderer LegpanelR5;
    private final ModelRenderer LegpanelR6;
    ...
    private final ModelRenderer LegpanelL6;
    ...
    public ModelSamuraiArmors(EntityEquipmentSlot slot, int armorState, float f) {
        super(f, 0, 128, 64);
        this.textureWidth = 128;
        this.textureHeight = 64;
        this.state = armorState;
        this.armorSlot = slot;
